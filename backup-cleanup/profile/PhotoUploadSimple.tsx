...
export const PhotoUploadSimple: React.FC<PhotoUploadSimpleProps> = ({ 
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      console.log('🎯 PhotoUploadSimple: Début upload de', files.length, 'fichier(s)');
      
      const uploadResult = await profileApi.uploadPhotos(filesArray);
      console.log('📥 Résultat upload PhotoUploadSimple:', uploadResult);
      ...
      console.error('❌ Erreur upload PhotoUploadSimple:', error);
